...
>
> - **Original PR:** #43
> - **Original author:** alhazayed (via Claude Code)
> - **Original date:** 2026-07-06
> - **Reason archived:** PR #43 closed during the v1.0.0 release-freeze repository cleanup; retained for provenance.
> - **Current status:** **Superseded by `main`.** Both hardening migrations (`20260706085712_repin_function_search_paths`, `20260706085904_revoke_public_execute_generate_patient_access_code`) are applied to production and present on `main`. SEC-3 (leaked-password protection) is tracked as an outstanding release-gate item.

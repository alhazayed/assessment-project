            ...
            {loading ? (
              ...
              <tr key={a.id} className={`hover:bg-gray-50 ${updating === a.id ? 'opacity-50' : ''}`}>
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2">
                    <div className="w-20 bg-gray-100 rounded-full h-1.5">
                      <div className="bg-indigo-500 h-1.5 rounded-full" style={{ width: `${(a.submission_count / maxSubs) * 100}%` }} />
                    </div>
                ...
                <td className="px-4 py-3 text-right">
                  <button onClick={() => toggle(a.id, a.is_active)} className="text-gray-400 hover:text-indigo-600 transition-colors">
                    {a.is_active

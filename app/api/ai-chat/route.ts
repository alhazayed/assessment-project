...
export async function POST(request: Request) {
  ...
  for (const turn of history) {
    ...
    // Scrub PHI before anything leaves for the third-party AI provider.
  ...
  contents.push({
    role: 'user',
    // Emergency detection already ran on the raw message above; the copy sent to
    // the third-party AI provider is PHI-scrubbed (defence in depth).
